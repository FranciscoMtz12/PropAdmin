/**
 * mobile-audit-v3.mjs — Reporte mobile SAPROA con formato exacto del original
...
const REPORT_PATH = path.join(REPORT_DIR, `mobile-audit-v3-${DATE_STR}.html`);
...
async function main() {
  ...
  /* ── TITULAR pages — fresh login per viewport ── */
  ...
  /* ───── ISSUES FOUND LIST (como el original) ───── */
  ...
  /* ───── HTML COMPLETO (formato exacto del original + lightbox) ───── */
  const html = `<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<title>SAPROA Mobile Audit v3 — ${DATE_STR}</title>
<style>
...
<div class="container">
  ...
  <p class="subtitle">Generated: ${DATE_STR} | Viewports: 375×812, 390×844, 414×896 | Base URL: https://www.saproa.com</p>
