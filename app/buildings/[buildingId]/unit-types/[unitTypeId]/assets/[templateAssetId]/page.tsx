    ...
    <PageContainer>
      ...
      <SectionCard title="Información actual" subtitle="Datos base del equipo plantilla dentro de la tipología." icon={<PackageOpen size={18} />}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(13.75rem, 1fr))", gap: 14 }}>
          ...
          <div style={{ border: "1px solid var(--border-default)", borderRadius: "var(--border-radius-lg)", padding: 14 }}><strong>Notas</strong><p style={{ margin: "8px 0 0 0", color: "var(--text-muted)" }}>{templateAsset.notes || "Sin notas"}</p></div>
        </div>
      </SectionCard>
      ...
      >
        <form onSubmit={handleUpdateTemplateAsset}>
          <div style={{ marginBottom: 16 }}>
            ...
            <select value={assetType} onChange={(e) => setAssetType(e.target.value)} style={{ width: "100%", padding: 12, border: "1px solid var(--border-default)", borderRadius: "var(--border-radius-md)", background: "var(--bg-card)" }}>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <input value={assetName} onChange={(e) => setAssetName(e.target.value)} style={{ width: "100%", padding: 12, border: "1px solid var(--border-default)", borderRadius: "var(--border-radius-md)" }} />
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
            <div>
              <label style={{ display: "block", marginBottom: 8 }}>Estatus</label>
              <select value={assetStatus} onChange={(e) => setAssetStatus(e.target.value)} style={{ width: "100%", padding: 12, border: "1px solid var(--border-default)", borderRadius: "var(--border-radius-md)", background: "var(--bg-card)" }}>
            ...
            <div>
              ...
              <input type="number" value={sortOrder} onChange={(e) => setSortOrder(e.target.value)} style={{ width: "100%", padding: 12, border: "1px solid var(--border-default)", borderRadius: "var(--border-radius-md)" }} />
            </div>
          </div>
          <div style={{ marginBottom: 16 }}>
            <label style={{ display: "block", marginBottom: 8 }}>Notas</label>
            <textarea value={notes} onChange={(e) => setNotes(e.target.value)} rows={4} style={{ width: "100%", padding: 12, border: "1px solid var(--border-default)", borderRadius: "var(--border-radius-md)", resize: "vertical" }} />
          </div>
