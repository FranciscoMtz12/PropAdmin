...
await Promise.all([
  shot(`${SITE}/collections`, '/tmp/col-rows.png', { scrollToBottom: true }),
  shot(`${SITE}/payments`, '/tmp/pay-manuales.png', { clickTab: 'Manuales' }),
  shot(`${SITE}/payments`, '/tmp/pay-services.png'),
])
console.log('Done.')
await browser.close()
