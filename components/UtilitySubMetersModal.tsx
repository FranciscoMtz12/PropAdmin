...
export default function UtilitySubMetersModal({
  ...
  return (
    <Modal open title={modalTitle} onClose={onClose} maxWidth="640px">
      <div style={{ display: "flex", alignItems: "flex-start", gap: 10, padding: "12px 14px", borderRadius: "var(--border-radius-lg)", background: "#fef3c7", color: "#92400e", fontSize: "0.8125rem", fontWeight: 600, lineHeight: 1.5, marginBottom: 20 }}>
