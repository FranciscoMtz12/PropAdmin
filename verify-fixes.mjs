...
const manualTab = await page.$('text=Manuales')
if (manualTab) { await manualTab.click(); await page.waitForTimeout(1200) }

// Screenshot before expand
await page.screenshot({ path: '/tmp/before-expand.png' })

// Click the first item row to expand it
const firstRow = await page.$('[style*="borderLeft"]')
if (firstRow) {
...
// Hover over a row and screenshot
if (firstRow) {
  await firstRow.hover()
  await page.waitForTimeout(400)
}
await page.screenshot({ path: '/tmp/on-hover.png' })
